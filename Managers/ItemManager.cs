...
public class Item
{
    ...
    internal static void Patch_ZNetSceneAwake(ZNetScene __instance)
    {
        foreach (Item item in registeredItems)
        {
            ...
            component.m_itemData.m_shared.m_startEffect = GetEffectList(item.startEffects);
            component.m_itemData.m_shared.m_holdStartEffect = GetEffectList(item.holdEffects);
            component.m_itemData.m_shared.m_equipEffect = GetEffectList(item.equipEffects);
            component.m_itemData.m_shared.m_unequipEffect = GetEffectList(item.unEquipEffects);
            component.m_itemData.m_shared.m_triggerEffect = GetEffectList(item.triggerEffects);
            component.m_itemData.m_shared.m_trailStartEffect = GetEffectList(item.trailStartEffects);
        }
    }

    internal static EffectList GetEffectList(List<string> effects)
    {
        EffectList output = new EffectList();
        ...
        output.m_effectPrefabs = data.ToArray();
        return output;
    }
